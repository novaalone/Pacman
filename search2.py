...
def depthFirstSearch(problem):
    ...
    explored_set = set()
    "*** Initialize a path, a latest path ***"
    path = []
    lastPath = []
    "*** Is the start a goal? ***"
    if problem.isGoalState(problem.getStartState()):
        ...
        return 'Stop'
    "*** Push start state into the stack , add the state to path***"
        ...
        if node not in explored_set:
            ...
            for x in successors:
                ...
                if x[0] not in explored_set:
                    ...
                    frontier.push(x[0])
                    "*** Initialize a temporary path which get the last path value ***" 
                    tempPath = [] 
                    tempPath = [elem for elem in lastPath]
                    tempPath.append(x)
